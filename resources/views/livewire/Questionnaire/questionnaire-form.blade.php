                    ...
                    <div class="step">
                        @foreach (['left_arm_circumference', 'waist_circumference', 'hip_circumference', 'chest_circumference'] as $keya)
                            <div class="flex gap-2 items-center mb-2">
                                ...
                                <input class="w-1/2 mt-2 block w-1/2 mx-auto h-[50px] text-xl px-4 py-2 rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0" type="text" name="{{ $questionKeys[$currentQuestionIndex] }}" wire:model.defer="{{ $keya }}" placeholder="{{ $questions[$keya]['placeholder'] }}">
                            </div>
                        @endforeach
                    </div>
                @endif
                        ...
                        <div class="step">
                            @foreach (['front_photo', 'side_photos', 'back_photo'] as $key)
                                <div class="flex gap-2 items-center mb-2">
                                    ...
                                    <input class="  mt-2 block w-1/2 px-4 py-2 rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0" type="file" name="{{ $questionKeys[$currentQuestionIndex] }}" wire:model.defer="{{ $key }}">
                                </div>
                            @endforeach
                        </div>
